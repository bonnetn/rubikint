...
sur internet, notre choix s'est porté sur la bibliothèque amateur \texit{webcam-capture} (cf. \url{https://github.com/sarxos/webcam-capture}).
...
Comme je vous l'ai dit, nous avons décidé de nous affranchir d'\texit{OpenCV}, il est donc impensable pour nous d'utiliser des méthodes de reconnaissance de contour
