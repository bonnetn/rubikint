...
\begin{figure}[h]
\begin{center}
	\makebox[\textwidth]{\includegraphics[width=.8\paperwidth]{diagrammes/Random\_generate.png}}
\end{center}
...
\begin{figure}[h]
\begin{center}
	\makebox[\textwidth]{\includegraphics[width=.8\paperwidth]{diagrammes/Random\_solve.png}}
\end{center}
	\caption{Interface  \textit{RandomSolverIhm} avec un cube mélangé}
\end{figure}
...
\begin{figure}[h]
\begin{center}
	\makebox[\textwidth]{\includegraphics[width=.8\paperwidth]{diagrammes/InteractivSolver\_acc.png}}
\end{center}
	\caption{ \textit{InteractivSolver\_acc}}
\end{figure}

\begin{itemize}
    \item Bouton capture : passe de la sène \texit{InteractivSolver\_acc}l à la scène \textit{InteractivSolver\_capture}
...
\begin{figure}[h]
\begin{center}
	\makebox[\textwidth]{\includegraphics[width=.8\paperwidth]{diagrammes/InteractivSolver\_capture.png}}
\end{center}
...
\begin{figure}[h]
\begin{center}
	\makebox[\textwidth]{\includegraphics[width=.8\paperwidth]{diagrammes/InteractivSolver\_solver.png}}
\end{center}
