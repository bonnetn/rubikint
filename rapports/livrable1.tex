...
\begin{center}
	\makebox[\textwidth]{\includegraphics[width=.8\paperwidth]{diagrammes/rendu3D.png}}
\end{center}
...
\begin{itemize}
    ...
    \item Une interface permettant la prise de photo du cube et donc de récupérer sa configuration pour qu'il puisse ensuite passer à sa résolution
